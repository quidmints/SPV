...
already exists*:
  • **ETH — none needed.** WETH exists independently; wrapping/unwrapping is an edge detail. The band
    ...
    duplicate state, which is the exact thing `State.sol`'s header says it exists to delete.**
