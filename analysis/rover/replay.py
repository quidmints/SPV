...
A v3 position's holdings are a closed form of (width, liquidity, price), so given the real daily price
...
earlier number in this thread conflated:
  ...
  FEES     the day's real pool volume x fee tier, credited ONLY while in range
           (Rover would be ~100% of in-width L: the rest of the pool is 0.000346 WETH-equiv)
  CADENCE  how often the width is re-placed at the live tick -- the thing being tested
...
print(f"{'cadence':<16}{'n':>4}{'LVR only':>12}{'+fees vs MIX':>15}{'vs HOLD-WETH':>15}{'in-width':>10}")
print("-" * 72)
