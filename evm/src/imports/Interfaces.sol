...
interface IBTCChannels {
    ...
    /// anyway, tag and field order copied. Declared here so the fixtures reach it through the ONE
    /// canonical interface rather than growing a second (standing rule 2).
    ...
    /// `#21`, where fixtures kept their own notion of `lpEth` and §E183 moved the contract's.
