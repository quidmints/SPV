...
// NOTE: upstream declares `IUniswapV3SwapCallback` inline here. Extracted to its own file so the
// concept has ONE declaration (it was also inline in the sibling router). Keep this on re-vendor.
