...
contract VBtcLevFeeLane is AllesFixture {
    ...
    function testReal_WbtcLev_FoldUp_Then_FlashDelever() public {
        ...
        lmW.rebalanceWbtc(lp, 0, DEX_WBTC_USDC);                     // flash-repay-first (flashProvider=MORPHO pinned in init)
    ...
    function testReal_WbtcRebalance_RejectsNativeVbtcVenue() public {
        ...
        lm.rebalanceWbtc(lp, 0, DEX_WBTC_USDC);                       // vBTC venue ⇒ BadTarget (WBTC-mode only)
    }
