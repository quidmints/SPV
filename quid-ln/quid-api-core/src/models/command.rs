...
use crate::types::{
    ...
    payments::{ClientPaymentId, PaymentCreatedIndex, PaymentUpdatedIndex},
};
...
/// Information about the Quid node.
//
...
pub struct CreateInvoiceRequest {
    ...
    /// payment instead of using Quid's default fees.
    ///
...
pub struct CreateOfferRequest {
    ...
    /// If `None`, offer issuer will encode "quid.io" as the issuer.
...
pub struct PayOnchainRequest {
    ...
    // See QuidEsplora for the conversion to the target number of blocks
