...
impl Invoice {
    ...
    /// Quid's main identifier for this payment, which for BOLT11 invoice
...
mod test {
    ...
    fn invoice_deser_compat() {
        let inputs = r#"
--- amount-less invoice, no description, Quid.app
...
--- 50 sat invoice w/ description, Quid.app
...
"#;
    ...
    // ```bash
    // $ cargo test -p quid-api-core -- --ignored invoice_dump --nocapture
    // ```
    #[ignore]
    #[test]
    fn invoice_dump() {
    ...
    // ```bash
    // $ cargo test -p quid-api-core -- --ignored invoice_print --nocapture
    // ```
    #[ignore]
    #[test]
    fn invoice_print() {
