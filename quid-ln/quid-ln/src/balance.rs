...
use crate::{alias::ChainMonitorType, traits::QuidPersister};

/// An estimate (in millionths) of the total proportional fees a Quid user will
...
/// An estimate of the total base fees a Quid user will pay when making an
...
pub fn all_channel_balances<PS: QuidPersister>(
...
pub fn channel_balance<PS: QuidPersister>(
    chain_monitor: &ChainMonitorType<PS>,
