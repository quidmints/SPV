//! The `quid-ln` crate contains shared Bitcoin + Lightning logic, utilities,
//! and newtypes.
...
use quid_std::fmt::{DebugIter, DisplayIter};
...
/// Traits.
pub mod traits;
/// MuSig2 (BIP327) key-path signing core for simple taproot channels.
pub mod deadman_exit;

pub mod taproot_signer;
/// Standalone validating Lightning channel signer (VLS-style policy engine).
pub mod validating_signer;
