...
use anyhow::anyhow;
use quid_api::{define_trace_id_fns, trace};
...
///
/// It is fine to clone and use the TracingLogger directly.
///
/// [`Logger`]: lightning::util::logger::Logger
/// [`tracing`]: https://crates.io/crates/tracing
#[derive(Clone)]
pub struct TracingLogger(InnerTracingLogger);
...
mod test {
    ...
    fn test_ldk_tracing_logger() {
        ...
        dispatcher::with_default(&dispatch, || {
            let ldk_logger = TracingLogger::new();
            ...
            ldk_logger.log(lightning::util::logger::Record {
                ...
                module_path: "quid_ln::logger::test",
                file: "logger.rs",
                line: 123,
                payment_hash: None,
            });
