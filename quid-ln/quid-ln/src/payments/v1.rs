...
use anyhow::Context;
#[cfg(test)]
use quid_api::types::payments::{PaymentHash, PaymentPreimage};
use quid_api::types::{
    invoice::Invoice,
    offer::Offer,
    payments::{
...
#[cfg(test)]
use quid_common::ln::priority::ConfirmationPriority;
use quid_common::{
...
impl PaymentV1 {
    ...
    ) -> quid_api::types::payments::BasicPaymentV2 {
        use quid_api::types::payments::PaymentKind;
