...
impl Args {
    ...
    pub fn run(self) -> Result<()> {
        ...
        use quid_run_sgx::aesm_proxy::AesmProxy;
        ...
        if !self.opts.debug {
            ...
            let key = quid_sgxs_sign::KeyPair::dev_signer();
...
mod test {
    ...
    fn test_parse_backtrace() {
        let input = r#"thread 'main' panicked at public/quid-sgx-test/src/main.rs:62:5:
foo failed!
stack backtrace:
   0:            0x2104c - <unknown>
   1:             0xdc8c - <unknown>
