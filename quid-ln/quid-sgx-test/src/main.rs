...
use quid_hex::hex;
use quid_tls::attest_client::verifier::{EnclavePolicy, SgxQuoteVerifier};
use quid_tls_attest_server::quote;

const HELP: &str = r#"
quid-sgx-test [OPTIONS] [TEST]
...
fn test_sgx() {
    ...
    let now = quid_tls::rustls::pki_types::UnixTime::now();
