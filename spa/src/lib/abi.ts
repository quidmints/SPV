...
export const RANGE_ABI = [
  ...
  // "the ETH yield-VENUE rides each deposit call: 0=Split(default) 1=ether.fi
  // 2=a v4 lender 3=Galaxy 4=ether.fi Rover 5=Euler". **None of those codes exist** — `evm/src`
