...
export const CONTRACTS: Contracts = {
  ...
  range:       ok(process.env.NEXT_PUBLIC_RANGE,        dep(l1.range)),
  rangeCore:   ok(process.env.NEXT_PUBLIC_RANGE_CORE,   dep(l1.core)),
  ...
  rangeCoreBtc: ok(process.env.NEXT_PUBLIC_RANGE_CORE_BTC,
                   dep((l1 as Record<string, string>).btcCore)),
  vault:       ok(process.env.NEXT_PUBLIC_VAULT,        dep(l1.vault)),
