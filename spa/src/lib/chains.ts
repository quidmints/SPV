...
export interface Contracts {
  ...
  vogue:       string  // ETH band manager (BTC side is `vault`, not a flag on this one)
  ...
  vogueCore:   string  // ETH engine — POOLED, POOLED_USD, observe, swapUsdBtc
  vogueCoreBtc: string // BTC engine — the SAME accessors on the WBTC/btcRisk instance
  // §E235-spa — the BTC BAND MANAGER, which the client never had an address for. Its BTC reads
  // used to work by calling BTC-suffixed accessors on `vogue`, because one contract carried both
...
export const CONTRACTS: Contracts = {
  ...
  vogueCoreBtc: ok(process.env.NEXT_PUBLIC_VOGUE_CORE_BTC,
